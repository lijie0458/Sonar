...
public class OtherReturnStorageDetailsEntityService extends AbstractService {
    ...
    public OtherReturnStorageDetailsEntityService() {
        ...
        entityFieldNameTitleMap.put("otherInSDetailsId", "其他入库详情id");
        ...
        entityFieldNameTitleMap.put("otherReturnSCode", "其他入库退回单号");
    ...
    **/
    ...
    public List<OtherReturnStorageDetailsEntity> batchUpdate(List<OtherReturnStorageDetailsEntity> entities, List<String> updateFields) {
        ...
        // updateFields为null时，默认全量更新
        List<OtherReturnStorageDetailsEntity> updateEntities = new ArrayList<>(entities.size());
        for (OtherReturnStorageDetailsEntity entity : entities) {
