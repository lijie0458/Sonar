...
public class OutsourceReturnStorageDetailsEntityService extends AbstractService {
    ...
    public OutsourceReturnStorageDetailsEntityService() {
        ...
        entityFieldNameTitleMap.put("outsourceInSDetailsId", "委外加工入库详情id");
        ...
        entityFieldNameTitleMap.put("quantity", "退回数量");
        entityFieldTitleNameMap.put("退回数量", "quantity");
        entityFiledColumnNameMap.put("quantity", "quantity");
        entityFieldNameTitleMap.put("outsourceReturnSCode", "委外加工入库退回单号");
    ...
    **/
    ...
    public List<OutsourceReturnStorageDetailsEntity> batchUpdate(List<OutsourceReturnStorageDetailsEntity> entities, List<String> updateFields) {
        ...
        // updateFields为null时，默认全量更新
        List<OutsourceReturnStorageDetailsEntity> updateEntities = new ArrayList<>(entities.size());
        for (OutsourceReturnStorageDetailsEntity entity : entities) {
