...
public class PerGroupPerMappingEntityService extends AbstractService {
    ...
    **/
    ...
    public List<PerGroupPerMappingEntity> batchUpdate(List<PerGroupPerMappingEntity> entities, List<String> updateFields) {
        ...
        // updateFields为null时，默认全量更新
        List<PerGroupPerMappingEntity> updateEntities = new ArrayList<>(entities.size());
        for (PerGroupPerMappingEntity entity : entities) {
