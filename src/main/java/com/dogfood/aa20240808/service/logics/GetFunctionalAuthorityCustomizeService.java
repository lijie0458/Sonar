...
public class GetFunctionalAuthorityCustomizeService {
    ...
    public List<PerGroupStructureStructure> getFunctionalAuthority() {
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_93457CC3B0554D8A97B8F80AD527F29E> variable1 = new ArrayList<>();
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_7FBB4AABBF5FC488B2988C81C738C5E5> variable2 = new ArrayList<>();
        ...
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_7FBB4AABBF5FC488B2988C81C738C5E5> variable5 = new ArrayList<>();
        List<PerGroupStructureStructure> result = new ArrayList<>();
        variable1 = CommonFunctionUtil.createListPage(getFunctionalAuthorityCustomizeServiceMapper.getAnonymousStructure_93457CC3B0554D8A97B8F80AD527F29E(), getFunctionalAuthorityCustomizeServiceMapper.countAnonymousStructure_93457CC3B0554D8A97B8F80AD527F29E().intValue(), com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_7AA66D6E2A21E3101B9C2B73B7971B38.class).list; 
        variable2 = CommonFunctionUtil.createListPage(getFunctionalAuthorityCustomizeServiceMapper.getAnonymousStructure_7FBB4AABBF5FC488B2988C81C738C5E5(), getFunctionalAuthorityCustomizeServiceMapper.countAnonymousStructure_7FBB4AABBF5FC488B2988C81C738C5E5().intValue(), com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_63A62260FC029F5392CCD931B361AF92.class).list; 
        for (Long index = 0L; index < variable1.size(); index++) {
            com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_93457CC3B0554D8A97B8F80AD527F29E item = variable1.get(index.intValue());
            CommonFunctionUtil.clear(variable3.permissionList);
