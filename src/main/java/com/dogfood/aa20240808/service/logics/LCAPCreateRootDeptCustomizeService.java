...
public class LCAPCreateRootDeptCustomizeService {
    ...
    public String lCAPCreateRootDept() {
        ...
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_47C167E7217746A55100F50A57F637C0> userList = new ArrayList<>();
        ...
        if ((CommonFunctionUtil.length(searchList).compareTo(0L) > 0)) {
            ...
            for (Long index = 0L; index < userList.size(); index++) {
                com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_47C167E7217746A55100F50A57F637C0 item = userList.get(index.intValue());
