...
public class UpdateInventoryByProductReutrnS1CustomizeService {
    ...
    public void updateInventoryByProductReutrnS1(String outsourceReturnCode, Boolean addOrReduce) {
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_DF6D8D35EA0AAF3BB5D5B1A4CC60635E> variable1 = new ArrayList<>();
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_DF6D8D35EA0AAF3BB5D5B1A4CC60635E> variable2 = new ArrayList<>();
        ...
        for (Long index = 0L; index < variable1.size(); index++) {
            com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_DF6D8D35EA0AAF3BB5D5B1A4CC60635E item = variable1.get(index.intValue());
            variable3 = false; 
        ...
        if ((CommonFunctionUtil.length(variable2).compareTo(0L) > 0)) {
            for (Long index = 0L; index < variable2.size(); index++) {
                com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_DF6D8D35EA0AAF3BB5D5B1A4CC60635E item = variable2.get(index.intValue());
                if (addOrReduce) {
