...
public class UpdateInventoryByProductReutrnSCustomizeService {
    ...
    public void updateInventoryByProductReutrnS(String productReturnCode, Boolean addOrReduce) {
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_12F96C5D8E74852BD6835250199AD981> variable1 = new ArrayList<>();
        List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_12F96C5D8E74852BD6835250199AD981> variable2 = new ArrayList<>();
        ...
        for (Long index = 0L; index < variable1.size(); index++) {
            com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_12F96C5D8E74852BD6835250199AD981 item = variable1.get(index.intValue());
            variable3 = false; 
        ...
        if ((CommonFunctionUtil.length(variable2).compareTo(0L) > 0)) {
            for (Long index = 0L; index < variable2.size(); index++) {
                com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_12F96C5D8E74852BD6835250199AD981 item = variable2.get(index.intValue());
                if (addOrReduce) {
