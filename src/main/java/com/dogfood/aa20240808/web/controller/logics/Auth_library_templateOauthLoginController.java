...
public class Auth_library_templateOauthLoginController {
    ...
    public ApiReturn<Object> oauthLogin(@RequestBody Auth_library_templateOauthLoginControllerDto body) throws Exception {
        return ApiReturn.of(com.netease.lowcode.template.oauth.OAuthConfigAuthService.nasl$$enhance$$oauthLogin(body.getCode(), FunctionContainer.getBean(body.getOauthFunction(), Function1.class)));
    } 
