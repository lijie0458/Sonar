...
public class Excel_parserParseAllSheetController {
    ...
    public ApiReturn<com.netease.lowcode.extension.excel.dto.ExcelParseResult> parseAllSheet(@RequestBody Excel_parserParseAllSheetControllerDto body) throws Exception {
        return ApiReturn.of(com.netease.lowcode.extension.excel.ExcelParser.parseAllSheet(body.getPath(), body.getRect(), body.getColumnFieldMap(), body.getRow(), body.getTypeArgumentClass(0)));
    } 
