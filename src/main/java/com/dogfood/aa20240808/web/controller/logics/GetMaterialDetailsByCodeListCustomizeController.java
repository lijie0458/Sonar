...
public class GetMaterialDetailsByCodeListCustomizeController {
    ...
    public ApiReturn<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_53DAF547B1A8EB1D1E8C43C4FE2C6055> getMaterialDetailsByCodeList(@RequestBody GetMaterialDetailsByCodeListCustomizeControllerDto body) throws Exception {
