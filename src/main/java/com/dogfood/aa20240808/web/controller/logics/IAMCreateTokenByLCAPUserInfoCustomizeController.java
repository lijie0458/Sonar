...
public class IAMCreateTokenByLCAPUserInfoCustomizeController {
    ...
    public ApiReturn<com.netease.lowcode.auth.domain.LCAPUser> iAMCreateTokenByLCAPUserInfo(@RequestBody IAMCreateTokenByLCAPUserInfoCustomizeControllerDto body) throws Exception {
