...
public class LCAPGetDeptListCustomizeController {
    ...
    public ApiReturn<List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_FF3D47421C85AD91C2FDAE6821984202>> lCAPGetDeptList(@RequestBody LCAPGetDeptListCustomizeControllerDto body) throws Exception {
