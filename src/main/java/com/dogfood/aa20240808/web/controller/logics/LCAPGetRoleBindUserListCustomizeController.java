...
public class LCAPGetRoleBindUserListCustomizeController {
    ...
    public ApiReturn<List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_E69C6A05AFC359D00B28F67D0E02C8E5>> lCAPGetRoleBindUserList(@RequestBody LCAPGetRoleBindUserListCustomizeControllerDto body) throws Exception {
