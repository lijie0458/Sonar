...
public class LCAPLoadRoleManagementTableViewCustomizeController {
    ...
    public ApiReturn<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_CAC5152BAE2C91DD609E3DFEE343ACC6> lCAPLoadRoleManagementTableView(@RequestBody LCAPLoadRoleManagementTableViewCustomizeControllerDto body) throws Exception {
