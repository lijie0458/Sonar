...
public class LoadDetailByidCustomizeController {
    ...
    public ApiReturn<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_610B5923CAECBB6E97D73C0B0B29A1EC> loadDetailByid(@RequestBody LoadDetailByidCustomizeControllerDto body) throws Exception {
