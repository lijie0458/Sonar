...
public class LoadProductionPageDetailsCustomizeController {
    ...
    public ApiReturn<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_14674722B95CA8C649EB3355ECF3BA6A> loadProductionPageDetails(@RequestBody LoadProductionPageDetailsCustomizeControllerDto body) throws Exception {
