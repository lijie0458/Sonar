...
public class LoadSupplierWithoutCurrentCustomizeController {
    ...
    public ApiReturn<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_11349FBCFFEB13D7A256774A83AFBFF4> loadSupplierWithoutCurrent(@RequestBody LoadSupplierWithoutCurrentCustomizeControllerDto body) throws Exception {
