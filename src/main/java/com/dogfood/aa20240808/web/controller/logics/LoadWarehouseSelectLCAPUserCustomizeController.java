...
public class LoadWarehouseSelectLCAPUserCustomizeController {
    ...
    public ApiReturn<List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_47C167E7217746A55100F50A57F637C0>> loadWarehouseSelectLCAPUser(@RequestBody LoadWarehouseSelectLCAPUserCustomizeControllerDto body) throws Exception {
