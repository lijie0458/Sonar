...
public class LoadsalesReturnUpdateSelectCustomizeController {
    ...
    public ApiReturn<List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_C807E715FC032F8BE6027971BB14D4D0>> loadsalesReturnUpdateSelect(@RequestBody LoadsalesReturnUpdateSelectCustomizeControllerDto body) throws Exception {
