...
public class LogicAssociatedDataCustomizeController {
    ...
    @Validation(value = { @ValidationRuleGroup(value = "4f50eb4a7ec54d8d9de5a3c625b8dfd5",rules = { }),@ValidationRuleGroup(value = "5cb0a34f1fb7450e816cc96cfa495240",rules = { })})
    @PostMapping("/api/lcplogics/logicAssociatedData")
    public ApiReturn<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_ABB51C5744639B1F415A73CB19AE729B> logicAssociatedData(@RequestBody LogicAssociatedDataCustomizeControllerDto body) throws Exception {
