...
public class OutsourceReturnStorageUpdateDataCustomizeController {
    ...
    public ApiReturn<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_918C890596FE76F2D0016F5A4227FA96> outsourceReturnStorageUpdateData(@RequestBody OutsourceReturnStorageUpdateDataCustomizeControllerDto body) throws Exception {
