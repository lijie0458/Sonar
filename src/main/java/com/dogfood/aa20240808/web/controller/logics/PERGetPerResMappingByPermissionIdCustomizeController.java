...
public class PERGetPerResMappingByPermissionIdCustomizeController {
    ...
    public ApiReturn<List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_D99966CE0A06FAAEEADD3A36C43F7DFF>> pERGetPerResMappingByPermissionId(@RequestBody PERGetPerResMappingByPermissionIdCustomizeControllerDto body) throws Exception {
