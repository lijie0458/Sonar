...
public class PERGetUserListByRoleIdCustomizeController {
    ...
    public ApiReturn<List<com.dogfood.aa20240808.domain.structure.anonymous.AnonymousStructure_B5031BE337A8E75F153A8EDD97EDE05B>> pERGetUserListByRoleId(@RequestBody PERGetUserListByRoleIdCustomizeControllerDto body) throws Exception {
